...
<div
    class="group relative bg-app-surface rounded-xl border border-app-border shadow hover:shadow-md transition-all duration-200 overflow-visible cursor-pointer flex flex-row items-center gap-3 p-2 md:gap-4 md:p-3 h-full"
