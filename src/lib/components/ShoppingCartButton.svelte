    ...
    <div class="relative">
        ...
        {#if itemCount > 0}
            <span
                ...
                class="absolute -top-1.5 -right-1.5 flex h-4.5 min-w-[18px] px-1 items-center justify-center rounded-full bg-gradient-to-br from-[#ef4444] to-[#c2410c] text-[10px] font-black text-white shadow-[0_2px_4px_rgba(0,0,0,0.2)] border-2 border-app-bg select-none"
            >
